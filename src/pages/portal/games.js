...
{/* TODO: Drop in playable microgames, leaderboard, and crowd-sourced rule mutation */}
<div className="mt-12 p-6 bg-black bg-opacity-60 backdrop-blur rounded-lg border-2 border-yellow-400 shadow-xl">
